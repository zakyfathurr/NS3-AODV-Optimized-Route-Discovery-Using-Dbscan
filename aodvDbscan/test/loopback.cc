 ...
 * \ingroup aodvDbscan
 *
 * \brief aodvDbscan loopback UDP echo test case
 */
 ...
 * \ingroup tests
 *
 * \brief aodvDbscan Loopback test suite
 */
class aodvDbscanLoopbackTestSuite : public TestSuite
{
public:
  aodvDbscanLoopbackTestSuite () : TestSuite ("routing-aodvDbscan-loopback", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // UDP Echo loopback test case
    AddTestCase (new LoopbackTestCase (), TestCase::QUICK);
  }
} g_aodvDbscanLoopbackTestSuite; ///< the test suite
