 ...
 */
#ifndef aodvDbscan_RQUEUE_H
#define aodvDbscan_RQUEUE_H
...
/**
 * \ingroup aodvDbscan
 * \brief aodvDbscan route request queue
 *
 * Since aodvDbscan is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
  ...
  /* get free queue len*/
  uint32_t GetFreeQueueLen ()
  {
    return m_maxLen - GetSize();
  }
  /**
   * Get queue timeout
