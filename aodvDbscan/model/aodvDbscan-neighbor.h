...
#ifndef aodvDbscanNEIGHBOR_H
#define aodvDbscanNEIGHBOR_H
...
public:
  ...
  // set cluster id
  void SetClusterId(Ipv4Address addr, uint32_t cid);
  /// get cluster id
  uint32_t GetClusterId(Ipv4Address addr);
