...
{
  static TypeId tid = TypeId ("ns3::aodvDbscan::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::aodvDbscan::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvDbscan")
...
{
  static TypeId tid = TypeId ("ns3::aodvDbscan::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvDbscan")
...
{
  static TypeId tid = TypeId ("ns3::aodvDbscan::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvDbscan")
...
{
  static TypeId tid = TypeId ("ns3::aodvDbscan::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvDbscan")
